  ...
  return (
    <>
      ...
      <main style={{ position:'relative', zIndex:1 }}>
        ...
        {/* ── HERO ── */}
        <section style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'120px clamp(20px,5vw,60px) 80px' }}>
          <div style={{ maxWidth:800 }}>
            <div style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(79,110,247,0.1)', border:'1px solid rgba(79,110,247,0.3)', borderRadius:100, padding:'6px 16px', fontFamily:'var(--font-mono)', fontSize:12, color:'var(--accent)', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:28, animation:'fadeInDown 0.8s ease both' }}>
            ...
            <h1 style={{ fontFamily:'var(--font-display)', fontWeight:800, fontSize:'clamp(40px,7vw,88px)', lineHeight:1.05, letterSpacing:'-0.03em', marginBottom:24, animation:'fadeInUp 0.8s ease 0.1s both' }}>
            ...
            <p style={{ fontSize:'clamp(16px,2vw,20px)', color:'var(--muted)', maxWidth:600, margin:'0 auto 40px', fontWeight:300, lineHeight:1.7, animation:'fadeInUp 0.8s ease 0.2s both' }}>
            ...
            <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap', marginBottom:60, animation:'fadeInUp 0.8s ease 0.3s both' }}>
            ...
            {/* Stats */}
            <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:'clamp(20px,5vw,50px)', flexWrap:'wrap', animation:'fadeInUp 0.8s ease 0.4s both' }}>
              {stats.map((s, i) => (
                <div key={i} style={{ textAlign:'center' }}>
                  <div style={{ fontFamily:'var(--font-display)', fontWeight:700, fontSize:'clamp(24px,3vw,32px)', background:'linear-gradient(135deg,var(--text),var(--accent))', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>{s.num}</div>
