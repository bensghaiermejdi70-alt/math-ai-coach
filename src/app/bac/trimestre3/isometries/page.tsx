...
const COURS = [
  { titre: "Isométries", contenu: "Conservation des distances: translation, rotation, symétrie axiale, symétrie centrale." },
  { titre: "Rotation (complexes)", contenu: "Rotation centre Omega, angle theta: z' - omega = e^(i·theta)·(z - omega)" },
  { titre: "Similitude directe", contenu: "f(z) = a·z + b avec a≠0. Rapport |a|, angle arg(a), centre fixe." },
  { titre: "Similitude indirecte", contenu: "f(z) = a·z_conj + b" },
  { titre: "Ellipse", contenu: "x²/a²+y²/b²=1 avec a>b>0. Foyers F(±c,0), c²=a²-b². Excentricité e=c/a." },
  { titre: "Hyperbole", contenu: "x²/a²-y²/b²=1. Foyers F(±c,0), c²=a²+b². Asymptotes y=±(b/a)x." }
]

const EXERCICES = [
  { num:"01", titre:"Rotation", diff:"facile", enonce:"Rotation O, angle pi/2. Image de z=1+i?" },
  { num:"02", titre:"Translation", diff:"facile", enonce:"Translation t=2+3i. Image de z=1-i?" },
  { num:"03", titre:"Similitude", diff:"moyen", enonce:"f(z)=(1+i)z+2. Nature, rapport, angle, centre." },
  { num:"04", titre:"Ellipse", diff:"moyen", enonce:"x²/9+y²/4=1. Foyers, sommets, excentricité." },
  { num:"05", titre:"Hyperbole", diff:"difficile", enonce:"x²/4-y²/9=1. Foyers, asymptotes." },
  { num:"06", titre:"Type Bac", diff:"bac", enonce:"f(z)=e^(i·pi/3)·z+1-i. Montrer rotation, trouver centre." }
]
    ...
    <>
      ...
      <main style={{ position:'relative', zIndex:1, paddingTop:80 }}>
        <div style={{ borderBottom:'1px solid var(--border)', padding:'14px clamp(20px,5vw,60px)', display:'flex', gap:8, fontSize:13, color:'var(--muted)', alignItems:'center' }}>
          ...
          <span style={{ color:'var(--text)' }}>Isométries, Similitudes & Coniques</span>
        </div>
        <div className="container" style={{ paddingTop:40, paddingBottom:80 }}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 300px', gap:32, alignItems:'start' }}>
            <div>
              <span className="badge badge-teal" style={{ marginBottom:12, display:'inline-block' }}>Géométrie · T3 · CH11</span>
              <h1 style={{ fontSize:'clamp(24px,4vw,40px)', marginBottom:12 }}>Isométries, Similitudes & Coniques</h1>
              <p style={{ maxWidth:500, marginBottom:16 }}>Transformations du plan complexe. Similitudes. Coniques (ellipse, hyperbole, parabole).</p>
              <div style={{ display:'flex', gap:16, fontSize:13, color:'var(--muted)', marginBottom:36 }}>
                <span>📝 14 exercices · Bac 2015-2024</span>
              </div>
            ...
            <div style={{ position:'sticky', top:100, display:'flex', flexDirection:'column', gap:16 }}>
              <div className="card" style={{ padding:20 }}>
                ...
                <div style={{ fontFamily:'var(--font-display)', fontWeight:700, fontSize:32, color:'var(--gold)' }}>45%</div>
                <div style={{ height:6, background:'var(--surface2)', borderRadius:100, margin:'8px 0 12px' }}><div style={{ height:'100%', width:'45%', background:'linear-gradient(90deg,var(--gold),var(--gold))', borderRadius:100 }} /></div>
              </div>
              <div className="card" style={{ padding:20 }}>
...
<Link key="/bac" href="/bac" style={{ display:"block", padding:"8px 12px", borderRadius:8, textDecoration:"none", fontSize:13, color:"var(--muted)", marginBottom:4 }}>← Retour Bac</Link>
              </div>
            </div>
          </div>
        </div>
