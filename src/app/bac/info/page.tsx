...
// ═══════════════════════════════════════════════════════════════
//  PAGE BAC TUNISIE — Maths / Physique-Chimie / Informatique / SVT
...
// ──────────────────────────────────────────────────────────────
//  DONNÉES INFORMATIQUE — Programme officiel CNP 2026
// ──────────────────────────────────────────────────────────────

// Section Sciences Informatiques : programme complet (Algo + BD + TIC)
const SECTION_INFO = {
  slug: 'informatique',
  icon: '💻',
  titre: 'Section Sciences Informatiques',
  ...
  blocs: [
    {
      ...
      chapitres: [
        { titre: 'Notions de base', sous: 'Algorithme, pseudo-code, variables (entier/réel/booléen/chaîne), déclaration, affectation, Read/Write' },
        { titre: 'Structures de contrôle', sous: 'IF / IF…ELSE / IF imbriqué · FOR / WHILE / REPEAT · Opérateurs AND/OR/NOT' },
        { titre: 'Structures de données', sous: 'Tableaux 1D et 2D · Chaînes de caractères (manipulation, fonctions) · Enregistrements (records, champs)' },
        { titre: 'Sous-programmes', sous: 'Procédures (sans retour) · Fonctions (avec retour) · Passage par valeur et par référence' },
        { titre: 'Algorithmes avancés', sous: 'Tri par sélection, tri par insertion · Recherche séquentielle et dichotomique · Complexité O(n) et O(log n)' },
        { titre: 'Programmation Pascal / Python', sous: 'Transformation algorithme → code · Syntaxe Pascal et Python · Débogage et test' },
      ],
      nbCh: 6,
    },
    {
      id: 'bd',
      icon: '🗄️',
      label: 'Bloc 2 — Bases de données',
      color: '#8b5cf6',
      bg: 'rgba(139,92,246,0.08)',
      border: 'rgba(139,92,246,0.2)',
      chapitres: [
        { titre: 'Concepts de base', sous: 'Définition BDD · Tables (enregistrements/champs) · Clé primaire · SGBD' },
        { titre: 'Modélisation relationnelle', sous: 'Modèle E/A · Relations 1-1, 1-N, N-N · Clé étrangère · Contraintes d\'intégrité' },
        { titre: 'SQL — Requêtes simples', sous: 'SELECT · FROM · WHERE · Alias · DISTINCT · Opérateurs de comparaison' },
        { titre: 'SQL — Requêtes avancées', sous: 'ORDER BY · GROUP BY · HAVING · JOIN (INNER/LEFT) · Sous-requêtes' },
        { titre: 'SQL — Manipulation DML', sous: 'INSERT INTO · UPDATE SET · DELETE FROM · Transactions' },
        { titre: 'Normalisation', sous: 'Éviter la redondance · 1FN, 2FN, 3FN · Dépendances fonctionnelles · Organisation optimale' },
      ],
      nbCh: 6,
    },
    {
      id: 'tic',
      icon: '🌐',
      label: 'Bloc 3 — TIC (Technologies de l\'Information)',
      color: '#06d6a0',
      bg: 'rgba(6,214,160,0.07)',
      border: 'rgba(6,214,160,0.2)',
      chapitres: [
        { titre: 'Internet & Réseaux', sous: 'LAN / WAN · Internet · Protocoles HTTP et TCP/IP · Adressage IP · Routage' },
        { titre: 'Web (HTML/CSS/JS)', sous: 'Structure HTML · Balises sémantiques · Mise en forme CSS · JavaScript (bases interactives)' },
        { titre: 'Systèmes informatiques', sous: 'Hardware (CPU, mémoire RAM/ROM, périphériques) · Software (OS, applications) · Architecture Von Neumann' },
        { titre: 'Sécurité informatique', sous: 'Virus et malwares · Pare-feu et antivirus · Cybersécurité · Chiffrement · Bonnes pratiques' },
      ],
      nbCh: 4,
    },
  ],
...
// Sections avec programme TIC commun (Maths, Sc.Exp, Sc.Tech, Éco-Gestion)
const SECTIONS_TIC_COMMUNES = [
  {
    slug: 'maths-scexp-sctech-eco',
    icon: '🎓',
    titre: 'Sections Maths / Sc.Exp / Sc.Tech / Éco-Gestion',
    coeff: 'Coefficient variable selon section',
    couleur: '#f59e0b',
    gradient: 'linear-gradient(135deg,rgba(245,158,11,0.12),rgba(217,119,6,0.06))',
    border: 'rgba(245,158,11,0.25)',
    note: 'Programme TIC commun — notions de culture numérique et usage des outils informatiques',
    blocs: [
      {
        id: 'internet',
        icon: '🌐',
        label: 'Internet & Réseaux',
        color: '#06d6a0',
        bg: 'rgba(6,214,160,0.07)',
        border: 'rgba(6,214,160,0.2)',
        chapitres: [
          { titre: 'Réseaux informatiques', sous: 'LAN / WAN · Internet · Client-serveur · Fournisseurs d\'accès (FAI)' },
          { titre: 'Protocoles de communication', sous: 'HTTP / HTTPS · TCP/IP · DNS · Adresse IP · Navigation web' },
        ],
      },
      {
        id: 'web',
        ...
        border: 'rgba(79,110,247,0.2)',
        chapitres: [
          { titre: 'HTML — Structure d\'une page', sous: 'Balises de base · Titres, paragraphes, liens, images · Structure sémantique' },
          { titre: 'CSS — Mise en forme', sous: 'Sélecteurs · Couleurs, polices, mise en page · Box model' },
          { titre: 'JavaScript (bases)', sous: 'Variables · Fonctions simples · Événements · Interaction basique' },
        ],
      },
      {
        id: 'systemes',
        ...
        border: 'rgba(139,92,246,0.2)',
        chapitres: [
          { titre: 'Hardware', sous: 'CPU (processeur) · Mémoire RAM et ROM · Périphériques E/S · Stockage (HDD, SSD)' },
          { titre: 'Software', sous: "Systèmes d'exploitation (Windows, Linux) · Applications · Logiciels libres vs propriétaires" },
        ],
      },
      {
        id: 'securite',
        ...
        chapitres: [
          { titre: 'Menaces et protection', sous: 'Virus, malwares, ransomwares · Antivirus et pare-feu · Mots de passe sécurisés' },
          { titre: 'Cybersécurité de base', sous: 'Phishing · Données personnelles · RGPD · Bonnes pratiques en ligne' },
        ],
      },
    ],
  },
...
// ──────────────────────────────────────────────────────────────
//  COMPOSANT CARTE INFORMATIQUE (bloc)
// ──────────────────────────────────────────────────────────────
function BlocInfo({ bloc }: { bloc: typeof SECTION_INFO['blocs'][0] }) {
  return (
    <div style={{ background: bloc.bg, border: `1px solid ${bloc.border}`, borderRadius: 16, padding: '20px 22px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
        <span style={{ fontSize: 22 }}>{bloc.icon}</span>
        <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 14, color: bloc.color }}>{bloc.label}</div>
        <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--muted)', background: 'rgba(255,255,255,0.06)', padding: '2px 10px', borderRadius: 20 }}>{bloc.nbCh} chapitres</span>
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(240px,1fr))', gap: 10 }}>
        {bloc.chapitres.map((ch, i) => (
          <div key={i} style={{ background: 'rgba(0,0,0,0.12)', borderRadius: 10, padding: '10px 14px' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: bloc.color, marginBottom: 4 }}>▸ {ch.titre}</div>
            <div style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.5 }}>{ch.sous}</div>
          </div>
        ))}
      </div>
    </div>
...
// ──────────────────────────────────────────────────────────────
//  COMPOSANT CARTE TIC COMMUNE
// ──────────────────────────────────────────────────────────────
function BlocTIC({ bloc }: { bloc: typeof SECTIONS_TIC_COMMUNES[0]['blocs'][0] }) {
  return (
    <div style={{ background: bloc.bg, border: `1px solid ${bloc.border}`, borderRadius: 14, padding: '16px 18px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
        <span style={{ fontSize: 18 }}>{bloc.icon}</span>
        <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 13, color: bloc.color }}>{bloc.label}</div>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {bloc.chapitres.map((ch, i) => (
          <div key={i}>
            <div style={{ fontSize: 12, fontWeight: 700, color: bloc.color, marginBottom: 2 }}>▸ {ch.titre}</div>
            <div style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.5 }}>{ch.sous}</div>
          </div>
        ))}
      </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 20, marginBottom: 52 }}>
              ...
              >
                ...
                <p style={{ fontSize: 13, color: 'var(--text2)', lineHeight: 1.65, margin: '0 0 18px' }}>
                  ...
                  4 sections : Maths · Sc.Exp · Sc.Tech · Info
                </p>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5, marginBottom: 20 }}>
                  {['Sc. Maths', 'Sc. Exp', 'Sc. Tech', 'Informatique'].map(t => (
              ...
              >
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5, marginBottom: 20 }}>
                  {['Sc. Info (complet)', 'Autres sections (TIC)'].map(t => (
        ...
        <main style={{ position: 'relative', zIndex: 1, paddingTop: 80 }}>
          <div className="container" style={{ paddingTop: 40, paddingBottom: 80 }}>
            <div style={{ marginBottom: 40 }}>
              <button onClick={() => setMatiere(null)} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 9, border: '1px solid var(--border)', background: 'var(--surface)', color: 'var(--muted)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-body)', marginBottom: 16, transition: 'all 0.15s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(79,110,247,0.45)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>
                ← Toutes les matières
              </button>
              <span className="label" style={{ marginBottom: 12, display: 'block' }}>🇹🇳 Programme officiel CNP Tunisie — 📐 Mathématiques</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 48 }}>
              {[{ num: '5', label: 'Sections', icon: '🎓' }, { num: '57+', label: 'Chapitres', icon: '📚' }, { num: '547+', label: 'Concepts', icon: '📐' }, { num: '442+', label: 'Exercices', icon: '📝' }].map(s => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              {SECTIONS_MATHS.map(sec => <CarteMaths key={sec.slug} sec={sec} />)}
            </div>
            <div style={{ marginTop: 52, background: 'linear-gradient(135deg,rgba(79,110,247,0.1),rgba(124,58,237,0.1))', border: '1px solid rgba(79,110,247,0.2)', borderRadius: 20, padding: 40, textAlign: 'center' }}>
              ...
              <p style={{ marginBottom: 24, maxWidth: 400, margin: '0 auto 24px', color: 'var(--text2)' }}>Teste-toi avec un vrai sujet de Bac — chrono, correction automatique et note estimée.</p>
            ...
            <div style={{ marginTop: 32, textAlign: 'center', display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => setMatiere('physique-chimie')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 13, color: 'var(--muted)', transition: 'all 0.18s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(6,214,160,0.4)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>⚗️ Voir Physique-Chimie →</button>
              <button onClick={() => setMatiere('informatique')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 13, color: 'var(--muted)', transition: 'all 0.18s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(99,102,241,0.4)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>💻 Voir Informatique →</button>
            </div>
          </div>
        </main>
        <Footer />
      ...
      <>
        ...
        <main style={{ position: 'relative', zIndex: 1, paddingTop: 80 }}>
          <div className="container" style={{ paddingTop: 40, paddingBottom: 80 }}>
            ...
            {/* Header */}
            <div style={{ marginBottom: 40 }}>
              <button onClick={() => setMatiere(null)} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 9, border: '1px solid var(--border)', background: 'var(--surface)', color: 'var(--muted)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-body)', marginBottom: 16, transition: 'all 0.15s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(99,102,241,0.45)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>
                ← Toutes les matières
              </button>
              <span className="label" style={{ marginBottom: 12, display: 'block' }}>🇹🇳 Programme officiel CNP Tunisie — 💻 Informatique</span>
              <h1 style={{ fontSize: 'clamp(26px,4vw,44px)', marginBottom: 12 }}>
                Informatique — Toutes Sections<br />
                <span style={{ color: '#818cf8' }}>Bac 4ème Année Secondaire</span>
              </h1>
              <p style={{ maxWidth: 620, color: 'var(--text2)', marginBottom: 20 }}>
                Programme complet pour la <strong style={{ color: '#818cf8' }}>Section Sciences Informatiques</strong> (Algorithmique + Bases de données + TIC)
                et programme TIC commun pour les <strong style={{ color: '#f59e0b' }}>autres sections</strong> (Maths, Sc.Exp, Sc.Tech, Éco-Gestion).
              </p>
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Link href="/examens" className="btn btn-secondary" style={{ textDecoration: 'none' }}>📋 Examens Bac</Link>
                <Link href="/chat" className="btn btn-ghost" style={{ textDecoration: 'none' }}>🤖 Chat IA →</Link>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 48 }}>
              {[
                { num: '3', label: 'Blocs', icon: '🧩' },
                { num: '16', label: 'Chapitres Info', icon: '💻' },
                { num: '2', label: 'Langages', icon: '🖥️' },
                { num: '4', label: 'Thèmes TIC', icon: '🌐' },
              ].map(s => (
                <div key={s.label} className="card" style={{ textAlign: 'center', padding: 20 }}>
                  <div style={{ fontSize: 22, marginBottom: 8 }}>{s.icon}</div>
                  <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 26, color: '#818cf8' }}>{s.num}</div>
                  <div style={{ fontSize: 12, color: 'var(--muted)' }}>{s.label}</div>
                </div>
              ))}
            </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
                ...
                <div>
                  <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 4 }}>
                    <h2 style={{ fontSize: 22, margin: 0, color: '#818cf8' }}>{SECTION_INFO.titre}</h2>
                    <span style={{ background: 'rgba(99,102,241,0.15)', color: '#818cf8', fontSize: 11, fontFamily: 'var(--font-mono)', padding: '3px 10px', borderRadius: 20 }}>{SECTION_INFO.coeff}</span>
                    <span style={{ background: 'linear-gradient(135deg,#6366f1,#a78bfa)', color: 'white', fontSize: 9, fontWeight: 800, padding: '2px 10px', borderRadius: 20 }}>COMPLET</span>
                  </div>
                  <p style={{ margin: 0, fontSize: 13, color: 'var(--muted)' }}>Programme complet en 3 grands blocs — Algorithmique · Bases de données · TIC</p>
                </div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                {SECTION_INFO.blocs.map(bloc => <BlocInfo key={bloc.id} bloc={bloc} />)}
              </div>
              <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                <Link href="/bac/info/informatique" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'linear-gradient(135deg,#6366f1,#a78bfa)', color: 'white', padding: '11px 24px', borderRadius: 12, fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 13, textDecoration: 'none', transition: 'opacity 0.2s' }} onMouseEnter={e => e.currentTarget.style.opacity = '0.85'} onMouseLeave={e => e.currentTarget.style.opacity = '1'}>
                  📚 Cours complets Informatique →
                </Link>
              </div>
            </div>

            {/* ═══ SECTIONS COMMUNES TIC ═══ */}
            <div style={{ background: 'rgba(245,158,11,0.05)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: 20, padding: '28px 32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
                <span style={{ fontSize: 36 }}>🎓</span>
                <div>
                  <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 4 }}>
                    <h2 style={{ fontSize: 20, margin: 0, color: '#f59e0b' }}>Sections Maths / Sc.Exp / Sc.Tech / Éco-Gestion</h2>
                    <span style={{ background: 'rgba(245,158,11,0.15)', color: '#f59e0b', fontSize: 10, fontFamily: 'var(--font-mono)', padding: '3px 10px', borderRadius: 20 }}>TIC COMMUN</span>
                  </div>
                  <p style={{ margin: 0, fontSize: 12, color: 'var(--muted)' }}>Programme TIC de base — culture numérique et usage des technologies</p>
                </div>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(280px,1fr))', gap: 16 }}>
                {SECTIONS_TIC_COMMUNES[0].blocs.map(bloc => <BlocTIC key={bloc.id} bloc={bloc} />)}
              </div>
            </div>

            {/* CTA bas */}
            <div style={{ marginTop: 52, background: 'linear-gradient(135deg,rgba(99,102,241,0.1),rgba(139,92,246,0.1))', border: '1px solid rgba(99,102,241,0.2)', borderRadius: 20, padding: 40, textAlign: 'center' }}>
              <h3 style={{ marginBottom: 12 }}>Prêt pour la simulation Bac Informatique ? 💻</h3>
              <p style={{ marginBottom: 24, maxWidth: 400, margin: '0 auto 24px', color: 'var(--text2)' }}>
                Teste-toi avec un vrai sujet — Algorithmique, SQL, Réseaux, correction automatique.
              </p>
              <Link href="/examens" className="btn btn-primary btn-lg" style={{ textDecoration: 'none' }}>Passer une simulation →</Link>
            </div>
            ...
            {/* Switchers */}
            <div style={{ marginTop: 32, textAlign: 'center', display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => setMatiere('maths')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 13, color: 'var(--muted)', transition: 'all 0.18s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(79,110,247,0.4)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>📐 Voir Mathématiques →</button>
              <button onClick={() => setMatiere('physique-chimie')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 13, color: 'var(--muted)', transition: 'all 0.18s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(6,214,160,0.4)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>⚗️ Voir Physique-Chimie →</button>
            </div>
          </div>
        </main>
  ...
  return (
    <>
      ...
      <main style={{ position: 'relative', zIndex: 1, paddingTop: 80 }}>
        <div className="container" style={{ paddingTop: 40, paddingBottom: 80 }}>
          <div style={{ marginBottom: 40 }}>
            <button onClick={() => setMatiere(null)} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 9, border: '1px solid var(--border)', background: 'var(--surface)', color: 'var(--muted)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-body)', marginBottom: 16, transition: 'all 0.15s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(6,214,160,0.45)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>
              ← Toutes les matières
            </button>
            <span className="label" style={{ marginBottom: 12, display: 'block' }}>🇹🇳 Programme officiel CNP Tunisie — ⚗️ Physique-Chimie</span>
            <h1 style={{ fontSize: 'clamp(26px,4vw,44px)', marginBottom: 12 }}>
              Physique-Chimie — Toutes Sections<br />
              <span style={{ color: '#06d6a0' }}>Bac 4ème Année Secondaire</span>
            </h1>
            <p style={{ maxWidth: 620, color: 'var(--text2)', marginBottom: 20 }}>
              Programme officiel CNP — Physique et Chimie complètes pour toutes les sections.
            </p>
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              <Link href="/examens" className="btn btn-secondary" style={{ textDecoration: 'none' }}>📋 Examens Bac</Link>
              <Link href="/chat" className="btn btn-ghost" style={{ textDecoration: 'none' }}>🤖 Chat IA →</Link>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            {SECTIONS_PC.map(sec => <CartePC key={sec.slug} sec={sec} />)}
          </div>
          <div style={{ marginTop: 40, background: 'rgba(6,214,160,0.05)', border: '1px solid rgba(6,214,160,0.18)', borderRadius: 14, padding: '16px 22px' }}>
            <p style={{ margin: 0, fontSize: 12, color: 'var(--text2)', lineHeight: 1.7 }}>
              <strong style={{ color: '#06d6a0' }}>ℹ️ Programme officiel CNP</strong> — Toutes les sections partagent un tronc commun en Physique et en Chimie.
            </p>
          </div>
          <div style={{ marginTop: 32, textAlign: 'center', display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={() => setMatiere('maths')} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 13, color: 'var(--muted)', transition: 'all 0.18s' }} onMouseEnter={e => e.currentTarget.style.borderColor = 'rgba(79,110,247,0.4)'} onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>📐 Voir Mathématiques →</button>
      ...
      <Footer />
      <style>{`@media(max-width:700px){div[style*="grid-template-columns: 1fr 1fr"]{grid-template-columns:1fr!important}div[style*="repeat(4,1fr)"]{grid-template-columns:repeat(2,1fr)!important}}`}</style>
    </>
  )
}