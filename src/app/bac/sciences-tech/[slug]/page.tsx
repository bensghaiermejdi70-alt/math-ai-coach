...
const NAV_ORDER = [
  ...
  'equations-differentielles','complexes',
...
const TITRES_NAV: Record<string,string> = {
  ...
  'statistiques':             'CH 12 — Statistiques',
  'denombrement':             'CH 13 — Dénombrement',
  'probabilites':             'CH 14 — Probabilités',
  'variables-aleatoires':     'CH 15 — Variables aléatoires',
}
