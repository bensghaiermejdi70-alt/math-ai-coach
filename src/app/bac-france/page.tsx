...
const MATIERES = [
  {
    ...
    icon: '🧮',
    titre: 'Mathématiques',
    desc: 'Seconde · Première Spé · Terminale Générale · Maths Expertes · Terminale Techno',
    couleur: '#f59e0b',
    gradient: 'linear-gradient(135deg,rgba(245,158,11,0.14),rgba(249,115,22,0.07))',
    border: 'rgba(245,158,11,0.3)',
    badge: '5 voies · 54 chapitres',
    badgeColor: '#fbbf24',
    stats: [
      { val: '5', label: 'voies' },
      { val: '54', label: 'chapitres' },
      { val: '419+', label: 'théorèmes' },
      { val: '364+', label: 'exercices' },
    ],
        ...
        <div className="container" style={{ paddingTop: 40, paddingBottom: 80 }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <p style={{ maxWidth: 600, color: 'var(--text2)', fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>
              Programmes officiels MEN 2026 · Seconde · Première & Terminale Générale · Voies Technologiques.
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 48 }}>
            {MATIERES.map(m => (
              <Link key={m.slug} href={m.href} style={{ textDecoration: 'none' }}>
                <div
                  style={{ background: m.gradient, border: `1px solid ${m.border}`, borderRadius: 22, padding: '32px 28px', transition: 'transform 0.2s, box-shadow 0.2s', cursor: 'pointer', position: 'relative', minHeight: 200 }}
