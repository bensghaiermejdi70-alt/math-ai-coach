...
const CHAPITRES: Record<string,{
  ...
  'radioactivite': {
    ...
    desc:'Stabilité des noyaux, radioactivité a ß ?, lois de conservation, loi de décroissance, temps de demi-vie, datation et applications médicales.',
    theoremes:[
      {id:'D1',type:'def',nom:'Stabilité des noyaux',enonce:'Un noyau est caractérisé par Z (protons) et N (neutrons), avec A = Z + N.\n\nDiagramme (N,Z) : les noyaux stables forment la "vallée de stabilité".\n• Si N/Z trop grand ? radioactivité ß?\n• Si N/Z trop petit ? radioactivité ß? ou capture électronique\n• Si A trop grand ? radioactivité a'},
      {id:'D2',type:'def',nom:'Types de radioactivité',enonce:'Radioactivité a : émission 42He\n? ?_Z X ? ??4_(Z-2) Y + 42He\n\nRadioactivité ß? : émission électron e? + antineutrino ?¯\n? ?_Z X ? ?_(Z+1) Y + °?1e + ?¯\n\nRadioactivité ß? : émission positron e? + neutrino ?\n? ?_Z X ? ?_(Z-1) Y + °?1e + ?\n\nRayonnement ? : photon ? haute énergie (Z et A inchangés)\n\nLois de conservation : conservation de A, de Z, de l\'énergie-masse'},
      {id:'F1',type:'formule',nom:'Loi de décroissance radioactive',enonce:'N(t) = N0 · e^(-?t)\n\nA(t) = A0 · e^(-?t)  [A = activité en Becquerel (Bq)]\n\nPériode radioactive (demi-vie) :\nt1/2 = ln2/? ˜ 0,693/?\n\nConstante radioactive :\n? = ln2/t1/2\n\nRelation N et A : A = ?N'},
      {id:'M1',type:'methode',nom:'Datation au carbone 14',enonce:'Principe : le ¹4C se désintègre avec t1/2 = 5730 ans.\n\nMéthode :\n1. Mesurer l\'activité A de l\'échantillon\n2. Connaître A0 (activité d\'un organisme vivant)\n3. Calculer : A/A0 = e^(-?t)\n4. Prendre ln : t = -(1/?)·ln(A/A0) = t1/2 · log2(A0/A)\n\nLimite : valable pour des âges de 500 à 50 000 ans.'},
    ],
    theoremes:[
      {id:'G1',type:'graphique',titre:'Courbe de décroissance radioactive N(t) = N0·e^(-?t)',legende:'En bleu : N(t). La demi-vie t1/2 correspond à N = N0/2',
  ...
  <!-- 2t1/2 -->
  <text x="258" y="197" fill="#8b5cf6" fontSize="11">2t1/2</text>
  ...
  <text x="10" y="124" fill="#8b5cf6" fontSize="11">N0/4</text>
  ...
  <!-- Formule -->
  <text x="300" y="70" fill="#ef4444" fontSize="13" fontWeight="bold">N(t) = N0·e^(-?t)</text>
</svg>`},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Activité après n demi-vies',enonce:'A0 = 6400 Bq, t1/2 = 2 h. Calculer A après 8 h.',correction:'8 h = 4 × t1/2\nA = A0/24 = 6400/16 = 400 Bq\nVérification : A = 6400 × e^(-?×8) avec ? = ln2/2 ˜ 0,347 h?¹\nA = 6400 × e^(-2,77) ˜ 400 Bq ?'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Équation de désintégration',enonce:'Le Polonium 210 se désintègre par radioactivité a. Écrire l\'équation. t1/2 = 138 j. Calculer ?. Fraction restante après 414 j.',correction:'Équation : ²¹°84Po ? ²°682Pb + 42He\n? = ln2/138 ˜ 5,02×10?³ j?¹\n414 j = 3 × t1/2\nN/N0 = 1/2³ = 1/8 = 12,5%'},
      {id:'EX03',niveau:'Intermédiaire',titre:'Datation',enonce:'Un échantillon a une activité A = A0/4. t1/2(¹4C) = 5730 ans. Quel est son âge ?',correction:'A/A0 = 1/4 = (1/2)² ? 2 demi-vies\nÂge = 2 × 5730 = 11 460 ans'},
    ],
  },

  'deuxieme-loi-newton': {
    ch:'CH 06', titre:'2ème loi de Newton', badge:'Mécanique', duree:'~7h', section:'Section 2 — Mécanique',
    desc:'Relation SF=ma, mouvements dans un champ uniforme (pesanteur, électrique), trajectoire parabolique, satellites et 3ème loi de Kepler.',
    theoremes:[
      {id:'T1',type:'thm',nom:'Deuxième loi de Newton',enonce:'Dans un référentiel galiléen :\nSF?_ext = m·a?\n\nProjections sur les axes :\nSF? = m·a?\nSF? = m·a?\n\n1ère loi : si SF? = 0? ? a? = 0? (MRU ou repos)\n3ème loi : F?(A?B) = -F?(B?A) (action-réaction)'},
      {id:'M1',type:'methode',nom:'Mouvement dans un champ uniforme',enonce:'Champ de pesanteur (sans frottements) :\nSeul le poids agit : P? = mg?\n\nÉquations du mouvement :\nSuivant x : a? = 0 ? v? = v0cosa ? x = v0cosa·t\nSuivant y : a? = -g ? v? = v0sina-gt ? y = v0sina·t - ½gt²\n\nTrajectoire parabolique : y = x·tana - gx²/(2v0²cos²a)\n\nPortée : R = v0²sin(2a)/g  (maximale pour a = 45°)\nHauteur max : H = v0²sin²a/(2g)'},
      {id:'F1',type:'formule',nom:'Satellites et loi de Kepler',enonce:'Gravitation universelle : F = GMm/r²\nG = 6,67×10?¹¹ N·m²·kg?²\n\nSatellite en orbite circulaire :\nGMm/r² = mv²/r\n? v = v(GM/r)\n? T = 2pr/v = 2pv(r³/GM)\n\n3ème loi de Kepler : T²/r³ = 4p²/(GM) = constante\n\nSatellite géostationnaire : T = 24h, orbite équatoriale'},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Chute libre',enonce:'Un objet est lâché sans vitesse initiale de h = 80 m. Calculer la durée de chute et la vitesse à l\'impact. (g = 10 m/s²)',correction:'y = h - ½gt² ? t_chute = v(2h/g) = v(2×80/10) = v16 = 4 s\nv = g·t = 10×4 = 40 m/s'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Projectile',enonce:'v0 = 20 m/s, a = 30°, g = 9,8 m/s². Calculer H et R.',correction:'H = v0²sin²a/(2g) = 400×(0,5)²/(2×9,8) = 100/19,6 ˜ 5,1 m\nR = v0²sin(2a)/g = 400×sin60°/9,8 = 400×0,866/9,8 ˜ 35,4 m'},
      {id:'EX03',niveau:'Difficile',titre:'Satellite géostationnaire',enonce:'M_Terre = 5,97×10²4 kg, G = 6,67×10?¹¹. Calculer r et v du satellite géostationnaire (T = 86400 s).',correction:'r³ = GMT²/(4p²) = 6,67×10?¹¹×5,97×10²4×(86400)²/(4p²)\nr³ = 7,54×10²² ? r ˜ 4,22×107 m ˜ 42 200 km\nv = 2pr/T = 2p×4,22×107/86400 ˜ 3068 m/s ˜ 3,1 km/s'},
    ],
  },
  ...
  'gaz-parfait': {
    ...
    theoremes:[
      {id:'F1',type:'formule',nom:'Équation d\'état du gaz parfait',enonce:'PV = nRT\n\nAvec :\n• P = pression en Pascal (Pa)\n• V = volume en m³\n• n = quantité de matière en mol\n• R = 8,314 J·mol?¹·K?¹\n• T = température en Kelvin (T = ?°C + 273,15)\n\nRelation entre états 1 et 2 :\nP1V1/T1 = P2V2/T2 = nR = cte\n\nMasse volumique : ? = PM/(RT)  (M = masse molaire)'},
      {id:'D1',type:'def',nom:'Transformations particulières',enonce:'Isotherme (T = cte) : PV = cte ? P1V1 = P2V2 (loi de Boyle-Mariotte)\n\nIsobare (P = cte) : V/T = cte ? V1/T1 = V2/T2 (loi de Charles)\n\nIsochore (V = cte) : P/T = cte ? P1/T1 = P2/T2 (loi de Gay-Lussac)\n\nAdiabatique : pas d\'échange thermique (Q = 0)'},
      {id:'F2',type:'formule',nom:'1er principe de la thermodynamique',enonce:'?U = W + Q  (convention récepteur)\n\nAvec :\n• ?U = variation d\'énergie interne (J)\n• W = travail reçu par le système (W < 0 si le gaz se détend)\n• Q = chaleur reçue par le système\n\nPour un gaz parfait : ?U ne dépend que de T\nSolide/liquide incompressible : ?U = m·c·?T\n\nCapacité thermique massique : Q = m·c·?T'},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Loi des gaz parfaits',enonce:'n = 0,5 mol de gaz à T = 300 K, V = 10 L. Calculer P. Puis P si V ? 5 L (isotherme).',correction:'P = nRT/V = 0,5×8,314×300/(10×10?³) = 1247/0,01 = 124 700 Pa ˜ 1,25 bar\nIsotherme : P2 = P1V1/V2 = 1,25×10/5 = 2,50 bar'},
      {id:'EX02',niveau:'Intermédiaire',titre:'1er principe',enonce:'On chauffe 200 g d\'eau de 20°C à 80°C. c = 4180 J·kg?¹·K?¹. Calculer Q. Travail si transformation isochore ?',correction:'Q = m·c·?T = 0,2×4180×60 = 50 160 J ˜ 50,2 kJ\nIsochore (V = cte) ? W = 0\n?U = Q = 50,2 kJ'},
    ],
  },
  ...
  <text x="120" y="112" fill="#6b7280" fontSize="10" textAnchor="middle">S1,S2</text>
  ...
  <text x="400" y="105" fill="#10b981" fontSize="11" fontWeight="bold">i = ?D/a</text>
  <!-- D -->
  ...
  <text x="255" y="200" fill="#4f6ef7" fontSize="10" textAnchor="middle">D</text>
    ...
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Interfrange',enonce:'Fentes de Young : a = 0,2 mm, D = 1,5 m, ? = 589 nm. Calculer i.',correction:'i = ?D/a = 589×10?? × 1,5 / (0,2×10?³)\ni = 8,835×10?7/2×10?4 = 4,42×10?³ m = 4,42 mm'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Différence de marche',enonce:'a = 1 mm, D = 2 m, ? = 600 nm. Pour x = 3 mm, calculer d. L\'interférence est-elle constructive ou destructive ?',correction:'d = ax/D = 10?³×3×10?³/2 = 1,5×10?6 m = 1500 nm\nd/? = 1500/600 = 2,5 ? d = 2,5? = (2+½)? ? DESTRUCTIVE (frange sombre)'},
    ],
  },

  'circuit-rc': {
    ch:'CH 16', titre:'Circuit RC', badge:'Électronique', duree:'~4h', section:'Section 4 — Ondes & Signaux',
    desc:'Charge et décharge d\'un condensateur à travers une résistance, constante de temps t=RC, équation différentielle du 1er ordre, capteurs capacitifs.',
    theoremes:[
      {id:'F1',type:'formule',nom:'Constante de temps et équations',enonce:'Constante de temps : t = RC  (en secondes, si R en O et C en Farads)\n\nCharge du condensateur (E = tension source) :\nu_C(t) = E·(1 - e^(-t/t))\ni(t) = (E/R)·e^(-t/t)\n\nDécharge du condensateur (tension initiale U0) :\nu_C(t) = U0·e^(-t/t)\ni(t) = -(U0/R)·e^(-t/t)\n\nÀ t = t : u_C = E·(1-e?¹) ˜ 0,63E (charge) ou u_C = U0·e?¹ ˜ 0,37U0 (décharge)\nPresque complètement chargé/déchargé à t = 5t'},
      {id:'D1',type:'def',nom:'Équation différentielle',enonce:'Lors de la charge : RC·(du_C/dt) + u_C = E\n\nC\'est une équation différentielle du 1er ordre à coefficients constants.\n\nSolution générale : u_C(t) = E + K·e^(-t/t)\nCondition initiale u_C(0) = 0 ? K = -E\n? u_C(t) = E·(1-e^(-t/t))\n\nVérification : à t=0, u_C=0 ? ; à t?8, u_C=E ?'},
    ...
    theoremes:[
      {id:'G1',type:'graphique',titre:'Charge et décharge du condensateur u_C(t)',legende:'Charge (bleu) : u_C = E(1-e^(-t/t)). Décharge (orange) : u_C = U0·e^(-t/t). À t=t : 63% ou 37%',
       svg:`<svg viewBox="0 0 500 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <!-- t -->
  <text x="145" y="197" fill="#06b6d4" fontSize="12">t</text>
  ...
  <!-- 5t -->
  <text x="318" y="197" fill="#aaa" fontSize="11">5t</text>
  <line x1="330" y1="175" x2="330" y2="185" stroke="#aaa" strokeWidth="1"/>
</svg>`},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Constante de temps',enonce:'R = 10 kO, C = 100 µF. Calculer t. À quel instant u_C = 9 V si E = 12 V ?',correction:'t = RC = 10×10³ × 100×10?6 = 1 s\nu_C = E(1-e^(-t/t)) ? 9 = 12(1-e^(-t))\ne^(-t) = 1-9/12 = 0,25\n-t = ln(0,25) = -1,386\nt ˜ 1,39 s ˜ 1,4t'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Décharge',enonce:'Un condensateur C = 50 µF chargé à U0 = 20 V se décharge dans R = 2 kO. Calculer t. Quand u_C = 5 V ?',correction:'t = RC = 2×10³×50×10?6 = 0,1 s\nu_C = U0·e^(-t/t) ? 5 = 20·e^(-t/0,1)\ne^(-10t) = 0,25 ? -10t = ln(0,25) ˜ -1,386\nt ˜ 0,139 s'},
    ],
  },
  ...
  'cinetique-chimique': {
    ...
    theoremes:[
      ...
      {id:'F1',type:'formule',nom:'Temps de demi-réaction',enonce:'t1/2 : durée pour que la concentration d\'un réactif diminue de moitié.\n\nA t1/2 : [A] = [A]0/2\n\nLecture graphique : sur la courbe [A] = f(t), tracer [A]0/2 et lire t1/2\n\nReaction d\'ordre 1 : t1/2 = ln2/k = 0,693/k  (k = constante de vitesse)\nReaction d\'ordre 0 : t1/2 = [A]0/(2k)'},
      {id:'M1',type:'methode',nom:'Lecture d\'une courbe cinétique',enonce:'Sur une courbe [réactif](t) :\n1. La tangente à l\'origine donne la vitesse initiale v0\n2. La pente diminue ? la réaction ralentit\n3. La courbe devient horizontale ? équilibre atteint\n\nSur une courbe [produit](t) :\n1. Croissante puis plateau\n2. La valeur plateau ? avancement maximal x_max'},
    ],
    theoremes:[
  ...
  <!-- [A]0 -->
  <text x="10" y="38" fill="#10b981" fontSize="11">[A]0</text>
  <line x1="45" y1="34" x2="55" y2="34" stroke="#10b981" strokeWidth="1" strokeDasharray="3"/>
  <!-- t1/2 -->
  <text x="158" y="197" fill="#aaa" fontSize="11">t1/2</text>
  ...
  <!-- [A]0/2 -->
  <text x="10" y="111" fill="#10b981" fontSize="11">[A]0/2</text>
  ...
  <text x="60" y="90" fill="#10b981" fontSize="10">pente = -v0</text>
</svg>`},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Temps de demi-réaction',enonce:'La courbe de [H2O2] en fonction du temps montre que [H2O2]0 = 0,80 mol/L et [H2O2] = 0,40 mol/L à t = 600 s. Déterminer t1/2.',correction:'t1/2 est le temps pour lequel [H2O2] = [H2O2]0/2 = 0,40 mol/L\nD\'après les données : t1/2 = 600 s = 10 min'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Influence de la température',enonce:'Une réaction a une vitesse v = 2×10?³ mol·L?¹·s?¹ à 25°C. Estimer v à 45°C en appliquant la règle de Van\'t Hoff.',correction:'?T = 45-25 = 20°C = 2 × 10°C\nSelon Van\'t Hoff : v est multiplié par 2 tous les 10°C\nv(45°C) = v(25°C) × 2² = 2×10?³ × 4 = 8×10?³ mol·L?¹·s?¹'},
    ],
  },
  ...
  'equilibres-chimiques': {
    ...
    exercices:[
      {id:'EX01',niveau:'Intermédiaire',titre:'Critère d\'évolution',enonce:'N2 + 3H2 ? 2NH3  K = 977 à 25°C. État initial : [N2]=1, [H2]=1, [NH3]=0,1 mol/L. Dans quel sens évolue le système ?',correction:'Qr = [NH3]²/([N2][H2]³) = (0,1)²/(1×1³) = 0,01\nQr = 0,01 < K = 977 ? Le système évolue dans le sens direct (? vers NH3)'},
      {id:'EX02',niveau:'Difficile',titre:'Calcul à l\'équilibre',enonce:'A ? B, K = 4. [A]0 = 1 mol/L, [B]0 = 0. Calculer [A] et [B] à l\'équilibre.',correction:'Tableau ICE : [A] = 1-x, [B] = x\nQr = x/(1-x) = K = 4\nx = 4(1-x) = 4-4x ? 5x = 4 ? x = 0,8 mol/L\n[A]_éq = 1-0,8 = 0,2 mol/L\n[B]_éq = 0,8 mol/L\nVérif : Qr = 0,8/0,2 = 4 = K ?'},
    ],
  },
  ...
  'dosages-titrages': {
    ...
    exercices:[
      ...
      {id:'EX02',niveau:'Intermédiaire',titre:'Titrage rédox',enonce:'On titre 20 mL de Fe²? par KMnO4 à C = 0,02 mol/L. V_E = 10 mL. La réaction est : MnO4? + 5Fe²? + 8H? ? Mn²? + 5Fe³? + 4H2O. Calculer [Fe²?].',correction:'n(MnO4?) = C·V_E = 0,02×0,010 = 2×10?4 mol\nD\'après l\'équation : n(Fe²?) = 5×n(MnO4?) = 5×2×10?4 = 10?³ mol\n[Fe²?] = n/V_a = 10?³/0,020 = 0,05 mol/L'},
    ],
  },
  ...
  <text x="315" y="105" fill="#10b981" fontSize="12">v = v(GM/r)</text>
  ...
  <text x="30" y="278" fill="#fbbf24" fontSize="11">T² = 4p²r³/GM</text>
</svg>`},
    ],
    exercices:[
      {id:'EX01',niveau:'Intermédiaire',titre:'Vitesse orbitale ISS',enonce:'L\'ISS orbite à h = 400 km d\'altitude. R_Terre = 6370 km, M_Terre = 5,97×10²4 kg. Calculer v et T.',correction:'r = R_Terre + h = 6370+400 = 6770 km = 6,77×106 m\nv = v(GM/r) = v(6,67×10?¹¹×5,97×10²4/6,77×106)\nv = v(5,88×107) ˜ 7668 m/s ˜ 7,7 km/s\nT = 2pr/v = 2p×6,77×106/7668 ˜ 5545 s ˜ 92 min'},
  ...
  'premier-principe': {
    ...
    theoremes:[
      ...
      {id:'F1',type:'formule',nom:'Capacité thermique',enonce:'Pour un solide ou liquide incompressible :\nQ = m·c·?T  (J)\n\nm = masse (kg)\nc = capacité thermique massique (J·kg?¹·K?¹)\n?T = T_finale - T_initiale (K ou °C)\n\nValeurs usuelles :\nc_eau = 4180 J·kg?¹·K?¹\nc_fer = 444 J·kg?¹·K?¹\nc_aluminium = 900 J·kg?¹·K?¹\n\nTaux d\'échange thermique :\nP = Q/t  (Watts)'},
      {id:'D1',type:'def',nom:'Transformations particulières',enonce:'Isochore (V = cte) : W = 0 ? ?U = Q\nIsobare (P = cte) : W = -P·?V\nIsotherme (T = cte) : pour gaz parfait ?U = 0 ? W = -Q\nAdiabatique (Q = 0) : ?U = W\n\nTemps caractéristique thermique :\nt_th = temps pour atteindre 63% de la variation totale de T\nVariation de T : T(t) = T_final + (T_i - T_final)·e^(-t/t_th)'},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Calcul de chaleur',enonce:'On chauffe 500 g d\'eau de 20°C à 100°C. c = 4180 J·kg?¹·K?¹. Calculer Q. La transformation est isochore. Calculer ?U.',correction:'Q = m·c·?T = 0,5×4180×80 = 167 200 J ˜ 167 kJ\nIsochore ? W = 0 ? ?U = Q = 167 kJ'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Mélange de deux liquides',enonce:'On mélange 200 g d\'eau à 80°C avec 300 g d\'eau à 20°C. Calculer T_mélange.',correction:'Échange thermique : Q_chaud + Q_froid = 0 (système isolé)\nm1·c·(T_m-T1) + m2·c·(T_m-T2) = 0\n0,2(T_m-80) + 0,3(T_m-20) = 0\n0,2T_m-16 + 0,3T_m-6 = 0\n0,5T_m = 22 ? T_m = 44°C'},
    ],
  },
  ...
  'enthalpie': {
    ...
    theoremes:[
      {id:'D1',type:'def',nom:'Enthalpie de réaction',enonce:'?rH = énergie échangée lors de la réaction (à pression constante)\n\n?rH < 0 : réaction exothermique (libère de la chaleur)\n?rH > 0 : réaction endothermique (absorbe de la chaleur)\n\nUnités : kJ/mol ou J/mol\n\nRéaction de combustion : toujours exothermique\nReaction de dissolution : peut être exo ou endothermique'},
      {id:'F1',type:'formule',nom:'Calcul par les énergies de liaison',enonce:'?rH = S E(liaisons rompues) - S E(liaisons formées)\n\nRupture de liaison : absorbe de l\'énergie (endothermique)\nFormation de liaison : libère de l\'énergie (exothermique)\n\nExemple : H2 + ½O2 ? H2O\nLiaisons rompues : 1×E(H-H) + ½×E(O=O) = 436 + 249 = 685 kJ/mol\nLiaisons formées : 2×E(O-H) = 2×463 = 926 kJ/mol\n?rH = 685 - 926 = -241 kJ/mol (exothermique ?)'},
    ...
    exercices:[
      {id:'EX01',niveau:'Intermédiaire',titre:'Énergie de combustion',enonce:'La combustion du méthane : CH4 + 2O2 ? CO2 + 2H2O. ?rH = -890 kJ/mol. Calculer l\'énergie libérée en brûlant 1 kg de méthane (M = 16 g/mol).',correction:'n = m/M = 1000/16 = 62,5 mol\nQ = n×|?rH| = 62,5×890 = 55 625 kJ ˜ 55,6 MJ\nCohérent avec PCI méthane ˜ 50 MJ/kg ?'},
    ],
  },
  ...
  'bilan-radiatif': {
    ...
    theoremes:[
      {id:'D1',type:'def',nom:'Rayonnement solaire et terrestre',enonce:'Constante solaire : f0 = 1361 W/m² (flux reçu au sommet de l\'atmosphère)\n\nAlbédo a : fraction de l\'énergie solaire réfléchie\nTerre : a ˜ 0,30 (30% réfléchi)\n\nÉnergie absorbée par la Terre :\nP_abs = f0·p·R²·(1-a)\n\nÉnergie réémise (loi de Stefan-Boltzmann) :\nP_ém = s·T4·4pR²\ns = 5,67×10?8 W·m?²·K?4'},
      {id:'T1',type:'thm',nom:'Température d\'équilibre',enonce:'À l\'équilibre : P_abs = P_ém\nf0·p·R²·(1-a) = s·T_éq4·4pR²\n\nT_éq = [f0(1-a)/(4s)]^(1/4)\n\nSans atmosphère : T_éq ˜ 255 K = -18°C\nAvec effet de serre naturel : T_obs ˜ 288 K = +15°C\n\nDifférence de 33°C due à l\'effet de serre naturel'},
      {id:'D2',type:'def',nom:'Effet de serre',enonce:'Les gaz à effet de serre (GES) : CO2, H2O, CH4, N2O, O3…\n\nMécanisme :\n1. Le Soleil émet des rayons visibles (courtes longueurs d\'onde)\n2. La surface terrestre absorbe et réémet de l\'infrarouge\n3. Les GES absorbent cet infrarouge et le réémet en partie vers la surface\n4. La surface se réchauffe davantage\n\nEffet de serre anthropique : augmentation de CO2 (combustibles fossiles) ? renforcement de l\'effet de serre ? réchauffement climatique'},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Température d\'équilibre',enonce:'Calculer T_éq de la Terre sans atmosphère. f0=1361 W/m², a=0,30, s=5,67×10?8 W·m?²·K?4.',correction:'T_éq = [f0(1-a)/(4s)]^(1/4)\n= [1361×0,70/(4×5,67×10?8)]^(1/4)\n= [952,7/(2,268×10?7)]^(1/4)\n= [4,2×10?]^(1/4)\n˜ 254,8 K ˜ 255 K ˜ -18°C'},
    ],
  },
  ...
  'effet-doppler': {
    ...
    exercices:[
      ...
      {id:'EX02',niveau:'Intermédiaire',titre:'Radar de vitesse',enonce:'Un radar émet à f0 = 24 GHz et reçoit un signal de f = 24,000 002 4 GHz d\'une voiture qui s\'approche. Calculer v. (c = 3×108 m/s)',correction:'?f = f-f0 = 2,4×10³ Hz\nv = c·?f/f0 = 3×108×2,4×10³/(24×10?) = 30 m/s = 108 km/h'},
    ],
  },

  'circuit-rlc': {
    ch:'CH 15', titre:'Circuit RLC — Résonance', badge:'Électronique', duree:'~5h', section:'Section 4 — Ondes & Signaux',
    desc:'Le circuit RLC en régime sinusoïdal forcé présente un phénomène de résonance à la pulsation ?0. C\'est la base des filtres et des systèmes de communication.',
    theoremes:[
      {id:'D1',type:'def',nom:'Régime sinusoïdal forcé',enonce:'Un circuit RLC série soumis à une tension u(t) = U_max·cos(?t) établit un régime permanent sinusoïdal de même fréquence.\n\nCourant : i(t) = I_max·cos(?t + f)\n\nImpédances :\n• Résistance R : Z_R = R (pas de déphasage)\n• Condensateur C : Z_C = 1/(C?) (courant en avance de p/2)\n• Bobine L : Z_L = L? (courant en retard de p/2)'},
      {id:'F1',type:'formule',nom:'Impédance et résonance',enonce:'Impédance totale RLC série :\nZ = v[R² + (L? - 1/C?)²]\n\nDéphasage :\ntan f = (L? - 1/C?)/R\n\nPulsation de résonance :\n?0 = 1/v(LC)  (rad/s)\nf0 = ?0/(2p)  (Hz)\n\nÀ la résonance : Z = R (minimum) ? I = U/R (maximum)\nL?0 = 1/(C?0) ? déphasage f = 0'},
      {id:'D2',type:'def',nom:'Facteur de qualité',enonce:'Facteur de qualité Q (sans unité) :\nQ = L?0/R = 1/(RC?0) = (1/R)·v(L/C)\n\nBande passante :\n?? = ?0/Q ? plus Q est grand, plus la résonance est sélective\n\nInterprétation :\n• Q grand (faible R) ? pic de résonance étroit et élevé\n• Q petit (grande R) ? résonance large et peu marquée\n\nApplications : filtre passe-bande, circuit accordé (radio, TV)'},
    ],
    theoremes:[
      {id:'G1',type:'graphique',titre:'Courbe de résonance I(?) — Circuit RLC série',legende:'À ?0 = 1/v(LC) : I est maximal. Plus Q est grand, plus le pic est étroit.',
       svg:`<svg viewBox="0 0 500 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <text x="475" y="184" fill="#aaa" fontSize="13">?</text>
  <text x="28" y="18" fill="#aaa" fontSize="11">I</text>
  <text x="238" y="197" fill="#8b5cf6" fontSize="12">?0</text>
  ...
  <text x="220" y="52" fill="#10b981" fontSize="10">?? = ?0/Q</text>
</svg>`},
    ],
    exercices:[
      {id:'EX01',niveau:'Facile',titre:'Pulsation de résonance',enonce:'L = 0,1 H, C = 10 µF. Calculer ?0 et f0.',correction:'?0 = 1/v(LC) = 1/v(0,1×10?5) = 1/v(10?6) = 1000 rad/s\nf0 = ?0/(2p) = 1000/(2p) ˜ 159 Hz'},
      {id:'EX02',niveau:'Intermédiaire',titre:'Impédance et courant',enonce:'R=100O, L=0,1H, C=10µF, U=10V, f=200Hz. Calculer Z, I et f.',correction:'? = 2p×200 ˜ 1257 rad/s\nZ_L = L? = 0,1×1257 = 125,7 O\nZ_C = 1/(C?) = 1/(10?5×1257) = 79,6 O\nZ = v(100²+(125,7-79,6)²) = v(10000+2122) = v12122 ˜ 110 O\nI = U/Z = 10/110 ˜ 91 mA\ntan f = (125,7-79,6)/100 = 0,461 ? f ˜ 25° (circuit inductif)'},
    ],
  },
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 300px', gap:32, alignItems:'start' }}>
            ...
            <aside style={{ position:'sticky', top:88 }}>
              <div style={{ background:'var(--surface)', border:'1px solid var(--border)', borderRadius:16, overflow:'hidden', marginBottom:14 }}>
                <div style={{ padding:'11px 15px', borderBottom:'1px solid var(--border)', fontSize:11, color:'var(--muted)', fontWeight:700, textTransform:'uppercase', letterSpacing:'0.08em' }}>?? Terminale PC — 16 chapitres</div>
                {NAV_ORDER.map((s,i) => (
