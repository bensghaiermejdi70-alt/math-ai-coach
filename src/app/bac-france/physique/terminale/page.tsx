                ...
                <div style={{ padding: '18px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <Link href={`/bac-france/physique/terminale/${ch.id}`}
                      style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 9, background: 'linear-gradient(135deg,#ef4444,#dc2626)', border: '1px solid #ef4444', color: 'white', fontSize: 12, fontWeight: 700, textDecoration: 'none' }}>
