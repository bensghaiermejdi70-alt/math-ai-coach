...
const SECTIONS = [
  {
    ...
    chapitres:[
      ...
      { ch:'CH 03', slug:'combinatoire-denombrement', titre:'Combinatoire & Dénombrement', badge:'Algèbre', nbThm:8, nbEx:10,
        desc:'Principes additif et multiplicatif, factorielle n!, arrangements, combinaisons C(n,p), triangle de Pascal, coefficients binomiaux, binôme de Newton (a+b)ⁿ.' },
    ],
  },
  {
    ...
    chapitres:[
      { ch:'CH 04', slug:'limites-continuite',    titre:'Limites & Continuité',            badge:'Analyse', nbThm:12, nbEx:12,
        desc:'Limite en un point (gauche/droite), asymptotes, formes indéterminées, croissances comparées, TVI, dichotomie.' },
      { ch:'CH 05', slug:'derivation-avancee',    titre:'Dérivation avancée',              badge:'Analyse', nbThm:8,  nbEx:10,
        desc:'Dérivée seconde, convexité (f\'\'≥0 ⟺ convexe), points d\'inflexion, théorème des accroissements finis (TAF).' },
      { ch:'CH 06', slug:'exponentielle', titre:'Fonction exponentielle', badge:'Analyse', nbThm:9, nbEx:11,
        desc:'Fonction exp, nombre e, positivité, croissance, dérivabilité, règles de calcul, limites en ±∞, croissances comparées avec les puissances, étude de fonctions composées, équations et inéquations.' },
      { ch:'CH 07', slug:'logarithme-neperien',   titre:'Logarithme népérien',             badge:'Analyse', nbThm:10, nbEx:12,
        desc:'Définition (primitive de 1/x), propriétés algébriques ln(ab), ln(a/b), ln(aⁿ), étude de ln x, croissances comparées.' },
      { ch:'CH 08', slug:'integration',           titre:'Intégration',                     badge:'Analyse', nbThm:10, nbEx:12,
        desc:'Primitives usuelles, intégrale définie ∫ₐᵇf(x)dx = F(b)−F(a), Chasles, IPP, changement de variable, aires, valeur moyenne.' },
      { ch:'CH 09', slug:'equations-differentielles', titre:'Équations différentielles',  badge:'Analyse', nbThm:8,  nbEx:10,
  ...
  },
  {
    ...
    chapitres:[
      { ch:'CH 10', slug:'vecteurs-espace',       titre:'Vecteurs & Repères dans l\'espace', badge:'Géométrie', nbThm:9, nbEx:10,
      ...
      { ch:'CH 11', slug:'droites-plans',         titre:'Droites & Plans — Équations',    badge:'Géométrie', nbThm:9, nbEx:10,
      ...
      { ch:'CH 12', slug:'produit-scalaire', titre:'Produit scalaire dans l\'espace', badge:'Géométrie', nbThm:9, nbEx:10,
        desc:'Produit scalaire (coordonnées), orthogonalité de vecteurs, droites et plans, distances point-droite et point-plan, angles, projections, applications.' },
    ],
  },
  {
    ...
    chapitres:[
      { ch:'CH 13', slug:'variables-aleatoires', titre:'Variables aléatoires', badge:'Probas', nbThm:8, nbEx:10,
        desc:'Variable aléatoire réelle, univers, loi de probabilité, espérance E(X), variance V(X), écart-type σ(X), linéarité, somme de variables aléatoires.' },
      { ch:'CH 14', slug:'lois-continues', titre:'Lois à densité (continues)', badge:'Probas', nbThm:7, nbEx:9,
        desc:'Fonction densité, aire sous la courbe, fonction de répartition, loi uniforme (espérance, variance), loi exponentielle (paramètre λ, durée de vie, propriété sans mémoire).' },
      { ch:'CH 15', slug:'loi-normale',           titre:'Loi normale (Gauss)',              badge:'Probas', nbThm:8,  nbEx:10,
        desc:'Densité N(μ,σ²), N(0,1), standardisation Z=(X−μ)/σ, propriétés de symétrie, intervalles μ±σ μ±2σ, Moivre-Laplace.' },
      { ch:'CH 16', slug:'loi-binomiale',         titre:'Loi binomiale B(n,p)',             badge:'Probas', nbThm:7,  nbEx:10,
        desc:'Épreuve de Bernoulli, schéma de Bernoulli, P(X=k)=C(n,k)pᵏ(1−p)ⁿ⁻ᵏ, E(X)=np, V(X)=np(1−p), diagrammes.' },
      { ch:'CH 17', slug:'echantillonnage',       titre:'Échantillonnage & Estimation',    badge:'Probas', nbThm:6,  nbEx:8,
  ...
  },
  {
    ...
    chapitres:[
      { ch:'CH 18', slug:'python-avance',         titre:'Python avancé & Algorithmique',   badge:'Info',   nbThm:5,  nbEx:8,
