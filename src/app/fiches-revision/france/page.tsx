...
import { FICHES_FRANCE } from '@/lib/fiches-data-france'
        ...
        <div className="container" style={{ paddingTop: 64, paddingBottom: 80, maxWidth: 1000 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ color: 'var(--text2)', fontSize: 15, maxWidth: 520, margin: '0 auto', lineHeight: 1.7 }}>
              Cours complets, quiz et questions-réponses par chapitre — Terminale.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(230px,1fr))', gap: 20 }}>
            {FICHES_FRANCE.map(m => {
              ...
              return m.disponible ? (
                <Link key={m.slug} href={`/fiches-revision/france/${m.slug}`} style={{ textDecoration: 'none', display: 'block' }}>
                  {card}
                </Link>
              ) : (
