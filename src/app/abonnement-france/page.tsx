...
// Architecture : Sélecteur matière → Plans 29/45/299€ par matière
// Maths  : prod_V6dFdN3xvDrqvh / prod_V6dK0UbPyTIqq7 / prod_V6dOBCQd4Hi13q
// Physique: prod_V6dQO0ROxpkFSh / prod_V6dSI78Kty9kef / prod_V6dVLQbooMvoAN
// SVT/Anglais/Info : "Bientôt disponible"
// ══════════════════════════════════════════════════════════════════

// ── Types ────────────────────────────────────────────────────────
type MatiereKey = 'mathematiques' | 'physique' | 'svt' | 'anglais' | 'informatique' | 'francais' | 'eco-gestion'
...
const MATIERES: {
  ...
  },
  {
    ...
    available: true,
    tagline: 'SES · STMG · Épreuve composée EC1/EC2/EC3 · Documents statistiques · Gestion-Finance (FDR/BFR/seuil)',
    accesPayant: [
      'Simulation SES & Gestion IA (Terminale · Première · Seconde · STMG)',
      'Chat Professeur Économie & Gestion',
      'Bac Blanc Éco-Gestion France',
      'Remédiation & Corrections (méthodo EC1/EC2/EC3 · dissertation · calculs)',
      'Analyses performance Éco-Gestion',
    ],
    accesFree: [
      'Cours SES officiels (Terminale Spé, Première Spé, Seconde)',
      'Cours STMG (Management · Droit · Économie · Gestion-Finance)',
      'Examens officiels SES + corrections (annales 2021–2025)',
      'Programme complet par section (Terminale · Première · Seconde · STMG)',
    ],
  },
]
  ...
  mathematiques: [
    {
      ...
      badge: null,
      stripeUrl: 'https://buy.stripe.com/7sY9AS48JeiUeqgecG0gw0v',
      priceId: 'price_1U6PzICwS8UwOtxyhxiaEPVQ',
      productId: 'prod_V6dFdN3xvDrqvh',
      accentColor: '#6366f1',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/eVq6oG8oZ6Qsgyo1pU0gw0w',
      priceId: 'price_1U6Q3NCwS8UwOtxykeh5Gw7k',
      productId: 'prod_V6dK0UbPyTIqq7',
      accentColor: '#f59e0b',
    ...
    },
    {
      ...
      stripeUrl: 'https://buy.stripe.com/cNicN448J5Mo6XOgkO0gw0x',
      priceId: 'price_1U6Q7NCwS8UwOtxyDotcFUNt',
      productId: 'prod_V6dOBCQd4Hi13q',
      accentColor: '#6366f1',
  ...
  physique: [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/fZu28q20B3Eg95Wc4y0gw0y',
      priceId: 'price_1U6Q9iCwS8UwOtxy1Na4eusE',
      productId: 'prod_V6dQO0ROxpkFSh',
      accentColor: '#06d6a0',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/00waEWax7b6Iaa08Sm0gw0z',
      priceId: 'price_1U6QBwCwS8UwOtxyMqNpwKJh',
      productId: 'prod_V6dSI78Kty9kef',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/eVqeVc7kV3Eg95W6Ke0gw0A',
      priceId: 'price_1U6QEcCwS8UwOtxyQJNhyx5h',
      productId: 'prod_V6dVLQbooMvoAN',
      accentColor: '#06d6a0',
  ...
  svt: [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/cNi6oGdJj5Mo1DuecG0gw0H',
      priceId: 'price_1U6QTGCwS8UwOtxyguDGFKTX',
      productId: 'prod_V6dkFTJ776RB5Z',
      accentColor: '#22c55e',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/00w8wO5cNcaM81SfgK0gw0I',
      priceId: 'price_1U6QVGCwS8UwOtxyRpra9Y4b',
      productId: 'prod_V6dmnLvUnFCWg2',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/fZu7sKax73Eg0zq5Ga0gw0J',
      priceId: 'price_1U6QXNCwS8UwOtxyl952JhyS',
      productId: 'prod_V6dpS2AbX6mVfe',
      accentColor: '#22c55e',
  ...
  anglais: [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/4gM5kC7kV1w85TKecG0gw0E',
      priceId: 'price_1U6QN3CwS8UwOtxypzFDzdUA',
      productId: 'prod_V6deJTojG9xtmO',
      accentColor: '#f43f5e',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/4gM7sK9t3eiU81S4C60gw0F',
      priceId: 'price_1U6QP3CwS8UwOtxykolFLBaY',
      productId: 'prod_V6dgJ7vIOzQP0p',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/28E4gy5cNfmYfuk2tY0gw0G',
      priceId: 'price_1U6QR8CwS8UwOtxyoua8p0H6',
      productId: 'prod_V6diS3RZ4fdJ8V',
      accentColor: '#f43f5e',
  ...
  informatique: [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/fZu6oG6gR0s4be48Sm0gw0B',
      priceId: 'price_1U6QGuCwS8UwOtxyvz4gMP7P',
      productId: 'prod_V6dY43RCpDZ3QV',
      accentColor: '#8b5cf6',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/fZu14mfRrfmY4PG2tY0gw0C',
      priceId: 'price_1U6QJ1CwS8UwOtxyt6kvT3Er',
      productId: 'prod_V6daMdtkAVsEJp',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/bJeeVcbBb0s4eqgecG0gw0D',
      priceId: 'price_1U6QL2CwS8UwOtxyU0tIOirD',
      productId: 'prod_V6dcnIDoxKNHkO',
      accentColor: '#8b5cf6',
  ...
  francais: [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/9B63cudJj1w881S9Wq0gw0K',
      priceId: 'price_1U6QZiCwS8UwOtxyWkwQjtXZ',
      productId: 'prod_V6drZ87iOWk2xf',
      accentColor: '#ec4899',
    ...
    },
    {
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/7sYdR88oZgr25TK4C60gw0L',
      priceId: 'price_1U6QbuCwS8UwOtxyWBdiPnQe',
      productId: 'prod_V6dtLb7RzUUIX2',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/9B64gycFf6Qs81Sc4y0gw0M',
      priceId: 'price_1U6Qe7CwS8UwOtxylEDUY6Is',
      productId: 'prod_V6dvzVlmF1nqp2',
      accentColor: '#ec4899',
  ...
  'eco-gestion': [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/7sYaEW8oZcaM4PG9Wq0gw0N',
      priceId: 'price_1U6Qg5CwS8UwOtxybRsqMNiP',
      productId: 'prod_V6dyx5q5a87t6D',
      accentColor: '#14b8a6',
    ...
    {
      id: 'sprint',
      name: 'Sprint Bac Éco-Gestion',
      icon: '🚀',
      price: 45,
      period: 'mois',
      description: 'Mai–juin uniquement · Bac Blanc Éco-Gestion inclus',
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/14A6oG8oZa2E4PG3y20gw0O',
      priceId: 'price_1U6QiBCwS8UwOtxyBL1wazod',
      productId: 'prod_V6e0iieWEF0HM5',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
    ...
    },
    {
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/dRmbJ05cN4Ikci8b0u0gw0P',
      priceId: 'price_1U6Ql0CwS8UwOtxyJw9OCNtn',
      productId: 'prod_V6e3LgfhGIOz5r',
      accentColor: '#14b8a6',
            ...
            <section style={{ maxWidth: 700, margin: '48px auto 0' }}>
              ...
              {[
                ...
                },
                {
                  ...
                  a: "Oui ! L'abonnement annuel (299 €/an) inclut automatiquement le mode Sprint Bac en mai et juin, avec les quotas boostés et le Bac Blanc débloqué.",
                },
                {
