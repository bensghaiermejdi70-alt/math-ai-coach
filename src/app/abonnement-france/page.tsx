...
const PLANS = [
  ...
  },
  {
    ...
    hoursColor: '#10b981',
    description: "Paiement unique · Toute l'année · Meilleure valeur",
      ...
      <main style={{ position:'relative', zIndex:1, minHeight:'100vh' }}>
        ...
        <section style={{ textAlign:'center', padding:'100px clamp(20px,5vw,60px) 40px', position:'relative' }}>
          ...
          <div style={{ display:'inline-flex', alignItems:'center', gap:8, marginTop:16, background:'rgba(245,158,11,0.08)', border:'1px solid rgba(245,158,11,0.25)', borderRadius:12, padding:'10px 18px', fontSize:12, color:'#fbbf24', maxWidth:520 }}>
            💡 <span><strong>En mai–juin :</strong> pour programme 19 eur passer au plan sprint bac pour les quotas boostés + Bac Blanc. Résiliable à tout moment.</span>
          </div>
        </section>
              ...
              <div key={plan.id} className="card" style={{
                ...
                >
                  {loading === plan.id ? (
                    ...
                    <>
                      <span>💳</span>
                      {plan.id === 'annuel' ? `Payer ${plan.price} € en une fois →` : `Commencer à ${plan.price} €/mois →`}
                    </>
                  )}
                </button>
