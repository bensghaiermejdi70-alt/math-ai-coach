  ...
  physique: [
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Physique', val: '10 / sem' },
        { label: 'Solveur Physique-Chimie', val: '10 / sem' },
        { label: 'Remédiation IA', val: '10 / sem' },
        { label: 'Analyses performance', val: '5 / sem' },
    ...
    },
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Physique', val: '15 / sem' },
        { label: 'Solveur Physique-Chimie', val: '15 / sem' },
        { label: 'Remédiation IA', val: '20 / sem' },
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours Physique-Chimie', val: '♾️ Illimité' },
        { label: 'Bac Blanc Physique', val: '✅ 5 / sem' },
      ],
    },
    {
      id: 'annuel',
      ...
      quotas: [
        ...
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours Physique-Chimie', val: '♾️ Illimité' },
        { label: 'Bac Blanc Physique (mai–juin)', val: '✅ 5 / sem' },
      ],
    },
  ],
  svt: [
    ...
    },
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA SVT', val: '15 / sem' },
        { label: 'Bac Blanc SVT', val: '✅ 5 / sem' },
        { label: 'Remédiation IA', val: '20 / sem' },
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours SVT', val: '♾️ Illimité' },
        { label: 'Examens officiels SVT', val: '♾️ Illimité' },
    ...
    },
    {
      ...
      quotas: [
        { label: 'Simulation SVT', val: '5 / sem' },
        { label: 'Chat IA SVT', val: '10 / sem' },
        { label: 'Bac Blanc SVT (mai–juin)', val: '✅ 5 / sem' },
        { label: 'Remédiation IA', val: '10 / sem' },
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours SVT', val: '♾️ Illimité' },
        { label: 'Examens officiels SVT', val: '♾️ Illimité' },
  ...
  anglais: [
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Professeur Anglais', val: '10 / sem' },
    ...
    },
    {
      ...
      quotas: [
        ...
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours & Annales LLCER', val: '♾️ Illimité' },
        { label: 'Bac Blanc Anglais (mai–juin)', val: '✅ 5 / sem' },
      ],
    },
  ],
  informatique: [
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Informatique', val: '10 / sem' },
        { label: 'Solveur Algo Python', val: '10 / sem' },
        { label: 'Remédiation IA', val: '10 / sem' },
        { label: 'Analyses performance', val: '5 / sem' },
    ...
    },
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Informatique', val: '15 / sem' },
        { label: 'Solveur Algo Python', val: '15 / sem' },
        { label: 'Remédiation IA', val: '20 / sem' },
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours NSI officiels', val: '♾️ Illimité' },
        { label: 'Bac Blanc NSI', val: '✅ 5 / sem' },
      ],
    },
    {
      id: 'annuel',
      ...
      quotas: [
        ...
        { label: 'Analyses performance', val: '10 / sem' },
        { label: 'Cours NSI officiels', val: '♾️ Illimité' },
        { label: 'Bac Blanc NSI (mai–juin)', val: '✅ 5 / sem' },
      ],
    },
  ],
  francais: [
    {
      ...
      quotas: [
        ...
        { label: 'Chat IA Professeur Français',     val: '10 / sem' },
    ...
    },
    {
      ...
      quotas: [
        ...
        { label: 'Analyses performance',            val: '10 / sem' },
        { label: 'Cours Philosophie & Français',    val: '♾️ Illimité' },
        { label: 'Bac Blanc Français (mai–juin)',   val: '✅ 5 / sem' },
      ],
    },
  ],
  'eco-gestion': [
    {
      ...
      description: 'Hors période mai–juin · Résiliable à tout moment',
      badge: null,
      stripeUrl: 'https://buy.stripe.com/aFafZg9t3eiUbe40lQ0gw0s',
      priceId: 'price_1Tgr8tCwS8UwOtxya4xZcWFR',
      productId: 'prod_UgDamjeXbC7NpE',
      accentColor: '#14b8a6',
      gradient: 'linear-gradient(135deg,#14b8a6,#0d9488)',
      shadowColor: 'rgba(20,184,166,0.35)',
      quotas: [
        { label: 'Simulation SES & Gestion',        val: '5 / sem' },
        { label: 'Chat IA Professeur Éco-Gestion',  val: '10 / sem' },
        { label: 'Correction IA (EC1/EC2/EC3)',     val: '20 / sem' },
        { label: 'Remédiation IA Éco-Gestion',      val: '10 / sem' },
        { label: 'Analyses performance',            val: '5 / sem' },
        { label: 'Cours SES & STMG officiels',      val: '♾️ Illimité' },
        { label: 'Bac Blanc Éco-Gestion',           val: '❌ Non inclus' },
      ],
    },
    {
      id: 'sprint',
      ...
      badge: '🔥 MAI – JUIN',
      stripeUrl: 'https://buy.stripe.com/9B600i7kVa2Eaa0b0u0gw0t',
      priceId: 'price_1TgrBPCwS8UwOtxyiuM00lEG',
      productId: 'prod_UgDcbgIHlRUHuL',
      accentColor: '#f59e0b',
      gradient: 'linear-gradient(135deg,#f59e0b,#f97316)',
      shadowColor: 'rgba(245,158,11,0.35)',
      quotas: [
        { label: 'Simulation SES & Gestion',        val: '10 / sem' },
        { label: 'Chat IA Professeur Éco-Gestion',  val: '15 / sem' },
        { label: 'Correction IA (EC1/EC2/EC3)',     val: '♾️ Illimité' },
        { label: 'Remédiation IA Éco-Gestion',      val: '20 / sem' },
        { label: 'Analyses performance',            val: '10 / sem' },
        { label: 'Cours SES & STMG officiels',      val: '♾️ Illimité' },
        { label: 'Bac Blanc Éco-Gestion',           val: '✅ 5 / sem' },
      ],
    },
    {
      id: 'annuel',
      ...
      description: 'Payé en une fois · Sprint mai–juin inclus',
      badge: '⭐ MEILLEURE VALEUR',
      stripeUrl: 'https://buy.stripe.com/9B69AS20B0s4aa0d8C0gw0u',
      priceId: 'price_1TgrE6CwS8UwOtxy5isKiv38',
      productId: 'prod_UgDfakOzYoOzWG',
      accentColor: '#14b8a6',
      ...
      quotas: [
        { label: 'Simulation SES & Gestion',        val: '5 / sem' },
        { label: 'Chat IA Professeur Éco-Gestion',  val: '10 / sem' },
        { label: 'Correction IA (EC1/EC2/EC3)',     val: '20/sem → ♾️' },
        { label: 'Remédiation IA Éco-Gestion',      val: '10 / sem' },
        { label: 'Analyses performance',            val: '10 / sem' },
        { label: 'Cours SES & STMG officiels',      val: '♾️ Illimité' },
        { label: 'Bac Blanc Éco-Gestion (mai–juin)', val: '✅ 5 / sem' },
      ],
    },
  ],
}
