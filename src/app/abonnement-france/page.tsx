...
// ── Types ────────────────────────────────────────────────────────
type MatiereKey = 'mathematiques' | 'physique' | 'svt' | 'anglais' | 'informatique'
...
const MATIERES: {
  ...
  },
  {
    ...
    available: false,
    tagline: 'Génétique · Immunologie · Physiologie · Géologie',
    accesPayant: [],
    accesFree: [],
  },
  {
    ...
    available: false,
    tagline: 'Grammar · Essay · Axes thématiques · Expression',
    accesPayant: [],
    accesFree: [],
  },
  {
    ...
    available: false,
    tagline: 'Algorithmique · SQL · Réseaux · Python',
    accesPayant: [],
    accesFree: [],
  },
]
  ...
  physique: [
    {
      ...
      quotas: [
        { label: 'Simulation Physique', val: '2 / sem' },
    ...
    },
    {
      ...
      quotas: [
        { label: 'Simulation Physique', val: '2→5 / sem' },
