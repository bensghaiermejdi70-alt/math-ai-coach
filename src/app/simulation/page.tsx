            ...
            <div style={{marginTop:16,width:'100%',background:'rgba(79,110,247,0.06)',border:'1px solid rgba(79,110,247,0.22)',borderRadius:16,padding:'20px 22px'}}>
              ...
              {matiere==='informatique' && (
                <p style={{fontSize:11.5,color:'#fca5a5',lineHeight:1.6,margin:'0 0 12px',background:'rgba(220,38,38,0.08)',border:'1px solid rgba(220,38,38,0.2)',borderRadius:10,padding:'10px 12px'}}>
                  ⚠️ Attention : l'Informatique a <strong>2 générations de sujet</strong> — <strong>Algorithmique</strong> et <strong>Base de données / Web</strong> (indiqué sur chaque archive). Choisis des archives du type voulu : tes instructions s'appliqueront à ce type.
                </p>
              )}
              <textarea
        ...
        <div>
          ...
          <div style={{marginTop:24,display:'flex',justifyContent:'space-between',alignItems:'center',gap:16,flexWrap:'wrap',paddingTop:16,borderTop:'1px solid rgba(255,255,255,0.07)'}}>
            ...
            <div style={{marginTop:16,width:'100%',background:'rgba(79,110,247,0.06)',border:'1px solid rgba(79,110,247,0.22)',borderRadius:16,padding:'20px 22px'}}>
              ...
              {matiere==='informatique' && (
                <p style={{fontSize:11.5,color:'#fca5a5',lineHeight:1.6,margin:'0 0 12px',background:'rgba(220,38,38,0.08)',border:'1px solid rgba(220,38,38,0.2)',borderRadius:10,padding:'10px 12px'}}>
                  ⚠️ Attention : l'Informatique a <strong>2 générations de sujet</strong> — <strong>Algorithmique</strong> et <strong>Base de données / Web</strong>. Le chapitre choisi ci-dessus détermine le type ; tes instructions s'appliqueront à ce type.
                </p>
              )}
              <textarea
                value={customInstructions}
    ...
    <>
      ...
      <main style={{minHeight:'100vh',paddingTop:80,background:'#0c0c1a',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{position:'relative',zIndex:1,maxWidth:1100,margin:'0 auto',padding:'40px 24px 80px'}}>
          ...
          {phase === 'select' && (
            <div style={{display:'flex',flexWrap:'wrap',alignItems:'center',gap:8,marginBottom:28,background:'rgba(255,255,255,0.04)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:16,padding:'12px 10px',width:'100%',overflowX:'auto',WebkitOverflowScrolling:'touch',scrollbarWidth:'thin'}}>
              {([
