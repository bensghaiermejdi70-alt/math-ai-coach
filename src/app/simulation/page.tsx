...
const CHAPITRES_PHYS: Record<string, {
  ...
  'scexp-phys': {
    ...
    chapitres: [
      ...
      // ── CHIMIE ────────────────────────────────────────────────────────────
      { slug:'oscillations-forcees-mec', titre:"Oscillations Mécaniques Forcées",    badge:"Physique T2", desc:"Oscillateur forcé, résonance mécanique x(t)=Xm·sin(ωt+φ), bande passante Δω=ω₀/Q, facteur de qualité Q." },
      { slug:'interaction-onde-matiere',  titre:"Interaction Onde-Matière",              badge:"Physique T3", desc:"Diffraction, interférences Young i=λD/a, effet photoélectrique E=hf, dualité onde-corpuscule λ=h/mv." },
  ...
  'sctech-phys': {
    ...
    chapitres: [
      ...
      // ── CHIMIE ────────────────────────────────────────────────────────────
      { slug:'interaction-onde-matiere-tech', titre:"Interaction Onde-Matière",         badge:"Physique T3", desc:"Diffraction, interférences Young i=λD/a, effet photoélectrique E=hf, dualité onde-corpuscule." },
  ...
  'info-phys': {
    ...
    chapitres: [
      ...
      // ── CHIMIE ────────────────────────────────────────────────────────────
      { slug:'filtres-elec',       titre:"Filtres Électriques",                  badge:"Physique T2", desc:"Filtres RC passe-bas fc=1/(2πRC), passe-haut, passe-bande, gain G=Us/Ue, G(dB)=20·log(Us/Ue), diagrammes de Bode." },
      { slug:'multivibrateurs',    titre:"Multivibrateurs & Électronique",        badge:"Physique T2", desc:"Multivibrateur astable, signal carré, T=1,4RC, transistors NPN (saturation/blocage), horloge électronique." },
