// ══ DONNÉES EXAMENS TUNISIE — module serveur (aucun 'use client') ══
// Extrait de page.tsx pour alléger le bundle client (perf/SEO).
...
export type AnneeLinks = { principale: Session; controle: Session }
export type ExData = { titre: string; theme: string; pts: number }
export type AnneeData = { year: number; exercices: ExData[]; note?: string }
...
// ════════════════════════════════════════════════════════════════
export type Matiere = 'maths' | 'physique' | 'informatique' | 'anglais' | 'svt' | 'francais' | 'economie' | 'gestion'
export type SKey = 'maths' | 'sc-exp' | 'sc-tech' | 'info' | 'eco' | 'sc-exp-phys' | 'sc-tech-phys' | 'math-phys' | 'info-phys' | 'info-algo' | 'info-bd' | 'anglais-lettres' | 'anglais-sciences' | 'svt-sc-exp' | 'svt-maths' | 'fr-lettres' | 'fr-scientifique' | 'economie' | 'gestion'
...
export const SECTIONS_FRANCAIS = [
...
export const SECTIONS_INFO_EXAM = [
...
export type Cell = { s: string; c: string }
